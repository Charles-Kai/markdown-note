...
> 计划写一波springboot 2.x源码分析，只写实用性比较高的特性，比较从[GitHub](https://github.com/spring-projects/spring-boot/tags?after=v1.0.0.RC3)上看出更新频率每月基本出个小版本。
...
- 配置 Spring Boot Bean 源：Java 配置 Class 或 XML 上下文配置文件集合，用于 Spring Boot BeanDefinitionLoader 读取 ，并且将配置源解析加载为
